...
parser.add_argument('-ncomm', '--num_comm', type=int, default=2, help='number of communications')
...
async def main():
    ...
    with tf.Session(config=tf.ConfigProto(
        ...
        # have fog device configs here
        myClients = {}
        for i in range(args.num_of_clients):
            myClients[f'fog{i}'] = f'127.0.0.1:500{i}'
        ...
        for i in tqdm(range(args.num_comm)):
            ...
            clients_in_comm = ['fog{}'.format(i) for i in order[0:num_in_comm]]
